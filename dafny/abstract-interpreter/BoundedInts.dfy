...
module BoundedInts {
  ...
  const TWO_TO_THE_32:  int := 0x1_0000_0000
  const TWO_TO_THE_40:  int := 0x100_0000_0000
  const TWO_TO_THE_48:  int := 0x1_0000_0000_0000
  const TWO_TO_THE_56:  int := 0x100_0000_0000_0000
